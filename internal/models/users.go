...
func (m *UserModel) Authenticate(email, password string) (int, error) {
	// retrieve the id & hashed pwd associated with given email, if
	// no match exists return ErrInvalidCredentials error
	var id int
	...
	// check wether hashed password and password provided match
	...
	// othewise pwd is correct, return user id
	return id, nil
}
